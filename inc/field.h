...
public:
	// конструктор класса инициализирующий массив field, принимает требуемые границы поля
	...
	// переменная win определяет показать все мины при выйгрыше или показывать флаги на клетках 
