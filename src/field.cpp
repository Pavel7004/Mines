...
void Field::place_mines(const short &numberOfMines) {
  ...
  // цикл остановиться когда количество генерированных мин будет равно
  // требуемому количеству мин
...
short Field::get_Number_of_mines() { return number_of_mines; }

// функция возвращает количество флагов, поставленных игроком
short Field::get_flag_count() { return flag_count; }
