...
int main(){
	...
	while (true){
		// главное меню игры
		cout << "Главное меню: " << endl << "1. Новая игра" << endl << "2. Выйти из игры" << endl;
		...
		again:
			...
			if (mass != nullptr && (num_mines >= 1 && num_mines < num_x * num_y))
				...
				// если поле не создалось или введенное значение не подходит то процесс создания поля начинается заново
			...
			while (true){
				...
				cout << "Количество флагов: " << mass->get_flag_count() << endl << endl <<"Количество мин: " << mass->get_Number_of_mines() << endl << endl;
				// вывод меню игры
				cout << "Меню игры:" << endl << "1. Открыть клетку" << endl << "2. Поставить флаг" << endl;
				...
				if (answ1 == "1"){
					...
					if ((number_x >= 1 && number_x <= 10) && (number_y >= 1 && number_y <= 10))
					//------------------------------------------------------------------------//
